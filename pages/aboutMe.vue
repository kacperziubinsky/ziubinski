<template>
  <section class="hero">
    ...
    <p><strong>Poznajmy się lepiej</strong> i rozpocznijmy owocną współpracę!</p>
  </section>
...
definePageMeta({
  ...
  schema: {
    ...
    knowsAbout: ['WordPress', 'Vue.JS', 'Node.JS', 'PHP', 'React', 'HTML', 'CSS', 'JavaScript'],
    url: 'https://twojastrona.com/o-mnie'
  },
  head: {
    meta: [
